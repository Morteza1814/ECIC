...
class CACHE : public MEMORY {
  public:
	...
	uint64_t l1d_addpq = 0;
	uint64_t l1i_addpq = 0;
	uint64_t l2c_addpq = 0;
	uint64_t pq_inserted = 0;
	uint64_t  pq_remove_hit=0;
	uint64_t  pq_remove_miss=0;
	uint64_t  pq_mshr_hit=0;
	uint64_t  mshr_type_change1=0;
	uint64_t  mshr_type_change2=0;
	uint64_t fill_l2_prefetches =0;
    // queues
