...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	cout <<	cache->NAME <<"-total_access : " << TOTAL_ACCESS << endl;
	cout <<	cache->NAME <<"-total_hit : " << TOTAL_HIT << endl;
	cout <<	cache->NAME <<"-total_miss : " << TOTAL_MISS << endl;
	
	cout <<	cache->NAME <<"-load_access : " << cache->sim_access[cpu][0] << endl;
	cout <<	cache->NAME <<"-load_hit : " << cache->sim_hit[cpu][0] << endl;
	cout <<	cache->NAME <<"-load_miss : " <<  cache->sim_miss[cpu][0] << endl;
	
	cout <<	cache->NAME <<"-rfo_access : " << cache->sim_access[cpu][1] << endl;
	cout <<	cache->NAME <<"-rfo_hit : " << cache->sim_hit[cpu][1] << endl;
	cout <<	cache->NAME <<"-rfo_miss : " <<  cache->sim_miss[cpu][1] << endl;
	
	cout <<	cache->NAME <<"-prefetch_access : " << cache->sim_access[cpu][2] << endl;
	cout <<	cache->NAME <<"-prefetch_hit : " << cache->sim_hit[cpu][2] << endl;
	cout <<	cache->NAME <<"-prefetch_miss : " <<  cache->sim_miss[cpu][2] << endl;
	
	cout <<	cache->NAME <<"-writeback_access : " << cache->sim_access[cpu][3] << endl;
	cout <<	cache->NAME <<"-writeback_hit : " << cache->sim_hit[cpu][3] << endl;
	cout <<	cache->NAME <<"-writeback_miss : " <<  cache->sim_miss[cpu][3] << endl;
	
	cout <<	cache->NAME <<"-prefetch_requested : " << cache->pf_requested << endl;
	cout <<	cache->NAME <<"-prefetch_issued : " << cache->pf_issued << endl;
	cout <<	cache->NAME <<"-prefetch_useful : " << cache->pf_useful << endl;
	cout <<	cache->NAME <<"-prefetch_useless : " << cache->pf_useless << endl;
	
	cout <<	cache->NAME <<"-Avg_miss_latency : " << (1.0*(cache->total_miss_latency))/TOTAL_MISS << "\n\n";
	
	cout <<	cache->NAME <<"-Morteza_l1daddpq : " << cache->l1d_addpq << "\n\n";
	cout <<	cache->NAME <<"-Morteza_l1iaddpq : " << cache->l1i_addpq << "\n\n";
	cout <<	cache->NAME <<"-Morteza_l2caddpq : " << cache->l2c_addpq << "\n\n";
	cout <<	cache->NAME <<"-Morteza_pq_inserted : " << cache->pq_inserted << "\n\n";
	cout <<	cache->NAME <<"-Morteza_pq_remove_hit : " << cache->pq_remove_hit << "\n\n";
	cout <<	cache->NAME <<"-Morteza_pq_remove_miss : " << cache->pq_remove_miss << "\n\n";
	cout <<	cache->NAME <<"-Morteza_pq_mshr_hit : " << cache->pq_mshr_hit << "\n\n";
	cout <<	cache->NAME <<"-Morteza_mshr_type_change1 : " << cache->mshr_type_change1 << "\n\n";
	cout <<	cache->NAME <<"-Morteza_mshr_type_change2 : " << cache->mshr_type_change2 << "\n\n";
	cout <<	cache->NAME <<"-Morteza_fill_l2_prefetches : " << cache->fill_l2_prefetches << "\n\n";
...
void reset_cache_stats(uint32_t cpu, CACHE *cache)
{
	...
	cache->l2c_addpq=0;
	cache->pq_inserted=0;
	cache->pq_remove_hit=0;
	cache->pq_remove_miss=0;
	cache->pq_mshr_hit=0;
	cache->mshr_type_change1=0;
	cache->mshr_type_change2=0;
	cache->fill_l2_prefetches=0;
}
...
int main(int argc, char** argv)
{
    ...
    for (uint32_t i=0; i<NUM_CPUS; i++) {
		...
		cout<<"\nSHEET"<<endl;
		cout<<"IPC : "<< ((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle)<<"\n\n";
